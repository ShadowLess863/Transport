...
public class TransportSim {
    ...
    public static void main(String[] args) {
        //Source with a certin number of humans hwo want to travel from point a to point b
    ...
    //method to compute time required for a given transpotationvehicle to travel x miles
